...
@section('content')
    ...
    <main class="safe-area py-4">
        <form action="{{route('auth.register')}}" class="register_form d-flex flex-column gap-05">
            @csrf
            <div>
            ...
            <div class="d-flex flex-column">
                ...
                <input
                    ...
                    id="name"
                    name="name"
                    class="normal-input @if($errors->has('name')) error @endif"
            ...
            <div class="d-flex flex-column">
                ...
                <p class="support-message">*Deve conter pelo menos 6 caracteres</p>
                @error('password')
                    <p class="error-message">
                        {{ $message }}
                    </p>
            ...
            <div class="d-flex flex-column">
                ...
                @enderror
                <button type="submit" class="btn-with-icon w-100 normal-btn mb-3">
                    Criar conta
